...
I am in the process of thrashing out enhancements to the Three.js First Person Controller.

When things settle down I will make a pull request to Mr.doob

2014-05-26 ~ MIT license
...
// Initial camera direction 
	...
	// run this when window size changes
...
// Opera / Explorer 9
			...
			if ( this.mouseDragOn ) {
				...
				this.movementSpeed = event.wheelDelta * 20; // 0.5;
				this.movementSpeed = THREE.Math.clamp( this.movementSpeed, this.movementSpeedMin, this.movementSpeedMax );
