...
//			'<p><a href=JavaScript:JAFO.openUrl(JAFO.template); >Create new empty scene</a></p>' +
	...
	V3TM.files = [
		...
		['assimp/interior/interior.3ds', 1, 'not yet' ],
		['assimp/interior/interior.3ds.json', 1, 'not yet' ],
		['assimp/jeep/jeep1.ms3d', 1, 'not yet' ],
		['assimp/jeep/jeep1.ms3d.json', 1, 'binary ok' ],
		...
		['gltf/duck/duck0FS.glsl', 1, 'not yet' ],
		['gltf/duck/duck0VS.glsl', 1, 'no yer' ],
		...
		['skinned/human_walk_0_female.js', 20, 'ok' ],
		['skinned/knight.js', 5, 'ok' ],
		['skinned/UCS_config.json', 1, 'not yet' ],
...
//			'<p><a href=JavaScript:JAFO.openUrl(JAFO.template); >Create new empty scene</a></p>' +
	...
	V3TO.files = [
		...
		['f50/F50NoUv_bin.js', 0.01, 'binary'],
		...
		['lucy/Lucy100k_bin.js', 0.1, 'binary'],
		['lucy/Lucy100k_slim.js', 0.1, 'ok' ],
		['male02/Male02_bin.js', 1, 'binary'],
		['male02/Male02_dds.js', 1, 'ok'  ],
		['male02/Male02_slim.js', 1, 'ok'  ],
		['ninja/NinjaLo_bin.js', 3, 'binary'],
		['suzanne/suzanne.js', 1, 'broken' ],
		['suzanne/suzanne.Monkey.003.js', 1, 'broken'  ],
		['suzanne/suzanneHi.js', 0.1, 'ok'  ],
		['suzanne/suzanneHi.Monkey.003.js', 1, 'brokeb' ],
		['tree/tree.js', 50, 'ok' ],
