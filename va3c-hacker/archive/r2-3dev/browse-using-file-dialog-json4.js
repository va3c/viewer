// 2014-11-23 ~ Theo Armour ~ MIT License
	...
	browseUsingFileDialogJSON4( location.hash );

	function browseUsingFileDialogJSON4( parameters ) {

		location.hash = '';

		VH.displayMarkdown( 'browse-using-file-dialog-json4.md', menuLeft );
...
//				msg2.innerHTML = output;
				...
				loadFileJSON4ByContents( output, '#na=objectToMonitor' );
