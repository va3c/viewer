Menubar.Edit = function ( editor ) {
	...
	function onUpdateAllToParentObject3DClick () {

		var mesh = new THREE.Object3D();
		mesh.name = 'Parent Object3D';
		...
		for ( var i = 0, len = editor.scene.children.length; i < len; i++ ) {

			child = editor.scene.children[ 0 ];
			type = editor.getObjectType( child );

			if ( (type !== 'Mesh' && type !== 'Object3D' ) || mesh == child )  {
	...
	var menuConfig = [
		...
		createOption( 'Update All to Parent Object3D', onUpdateAllToParentObject3DClick ),
